...
| App | Description |
| --- | --- |
| [`anvi`](bucket/anvi.json) | Tray-resident tool that edits the focused input field of any Windows app in an embedded Neovim ([upstream](https://github.com/sg004baa/anywhere-nvim)) |
